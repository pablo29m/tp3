...
def create_table():
    conn = sqlite3.connect(r'C:\Users\Pablo\Desktop\tp3\basedatos.db')  # Cambia 'TuUsuario' por tu nombre de usuario en Windows
    cursor = conn.cursor()
...
@app.route('/')
def index():
    conn = sqlite3.connect(r'C:\Users\Pablo\Desktop\tp3\basedatos.db')
    cursor = conn.cursor()
